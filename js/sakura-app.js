...
$(function () {
  ...
  console.log('%c hojun_Github_theme %c', 'background:#24272A; color:#ffffff', '', 'https://github.com/honjun/hexo-theme-sakura')
  console.log('%c MoStone_Github_theme  %c', 'background:#24272A; color:#ffffff', '', 'https://github.com/mo-stone-0214/mo-stone-0214.github.io')
})
